...
class RedisCache(BaseCache):
    ...
    def __init__(
        ...
        if redis_client:
            ...
            self._redis = redis.Redis(
                ...
                db=db,
                password=password,
                decode_responses=False # We want bytes for pickle
            )
    ...
    def clear(self) -> None:
        # Danger: Keys scanning to clear only prefix-matched keys
        cursor = '0'
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "db_keys": self._redis.dbsize() # Note: this is total keys in DB, not just prefix
        }
