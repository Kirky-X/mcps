...
class TestThreadPoolControl:
    ...
    async def test_performance_scaling(self):
        ...
        for max_workers in [1, 2, 4, 8]:
            ...
            print(f"线程数 {max_workers}: {execution_time:.2f}秒, 成功 {response.summary.success}, 失败 {response.summary.failed}")
...
class TestConcurrentExecution:
    ...
    async def test_mixed_language_concurrent_processing(self):
        ...
        expected_languages = {lang.value for lang in [Language.PYTHON, Language.RUST, Language.NODE, Language.JAVA, Language.GO, Language.CPP]}
